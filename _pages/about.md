...
- **Programming:** Python, C, JavaScript/TypeScript, Git, Docker, Jekyll
- **AI & ML:** LoRA Fine-tuning (LLaMA), Multi-Agent Pipelines, Deep Learning Theory (CNN/RNN/Transformer)
- **Tools:** Obsidian (PKM), Figma, Google Colab, Hugging Face
