...
| --------------------------- | --------------------- | ------------------------------------------------- |
| **Python**                  | Intermediate          | AI/ML research, scripting, automation             |
| **C**                       | Intermediate          | University coursework (A+), systems understanding |
| **JavaScript / TypeScript** | Beginner–Intermediate | J.A.R.V.I.S. orchestration runtime (Node.js)      |
| **HTML / CSS**              | Working knowledge     | Portfolio, UI prototyping                         |
...
| **Docker**       | Isolated code execution sandbox in J.A.R.V.I.S.     |
| **Obsidian**     | Personal Knowledge Management, research note-taking |
| **Figma**        | UI prototyping (J.A.R.V.I.S. Rainmeter skin)        |
| **Jekyll**       | This portfolio site (al-folio theme)                |
